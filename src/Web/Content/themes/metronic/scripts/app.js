...
var App = function () {
    ...
    var handleUniform = function () {
        ...
        var test = $("input[type=checkbox]:not(.toggle), input[type=radio]:not(.toggle, .star)").not('[data-dgd-check-toggle]');
        if (test.size() > 0) {
            test.each(function(){
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            jQuery(el).block({
                message: '<img src="/Content/themes/metronic/img/ajax-loading.gif" align="">',
